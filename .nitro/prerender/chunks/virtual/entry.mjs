import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineHandler, H3, redirect, getRequestIP, parseCookies, getCookie, setCookie, fromWebHandler } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/h3/dist/_entries/node.mjs';
import { getRequestEvent, renderToString, renderToStream, createComponent, ssr, ssrHydrationKey, ssrAttribute, escape, isServer, delegateEvents, spread, useAssets as useAssets$1, ssrElement, mergeProps, NoHydration, Hydration, HydrationScript } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/solid-js/web/dist/server.js';
import { getManifest } from 'solid-start:get-manifest';
import { sharedConfig, Suspense, useContext, onCleanup, createSignal, createEffect, onMount, createContext, createUniqueId, lazy as lazy$1, createRenderEffect, children, createMemo, getOwner, on, runWithOwner, untrack, Show, createRoot, startTransition, resetErrorBoundaries, batch, createComponent as createComponent$1, catchError, ErrorBoundary as ErrorBoundary$1 } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/solid-js/dist/server.js';
import { createRouter as createRouter$1 } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/radix3/dist/index.mjs';
import { fromJSON, crossSerializeStream, getCrossReferenceHeader } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/seroval/dist/esm/production/index.mjs';
import { CustomEventPlugin, DOMExceptionPlugin, EventPlugin, FormDataPlugin, HeadersPlugin, ReadableStreamPlugin, RequestPlugin, ResponsePlugin, URLSearchParamsPlugin, URLPlugin } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/seroval-plugins/dist/esm/production/web.mjs';
import { join } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/pathe/dist/index.mjs';
import { provideRequestEvent } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/solid-js/web/storage/dist/storage.js';
import { parseSetCookie } from 'file:///home/thoisoi/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B/Projects/js/university/node_modules/cookie-es/dist/index.mjs';
...
const getAssets = async (id) => {
  ...
  const manifest2 = getManifest("client");
...
const fileRoutes = [{ "page": true, "$component": { "src": "src/routes/[...404].tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/_...404_-Be67uQaC.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/_...404_-Be67uQaC.mjs'
) }, "path": "/*404" }, { "page": true, "$component": { "src": "src/routes/authors.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/authors-DS0nxUX7.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/authors-DS0nxUX7.mjs'
) }, "path": "/authors" }, { "page": true, "$component": { "src": "src/routes/index.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/index-Co0IYmh_.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/index-Co0IYmh_.mjs'
) }, "path": "/" }, { "page": true, "$component": { "src": "src/routes/location.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/location-lkX6yV2k.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/location-lkX6yV2k.mjs'
) }, "path": "/location" }, { "page": true, "$component": { "src": "src/routes/structure.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/structure-C9Fh7hU7.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/structure-C9Fh7hU7.mjs'
) }, "path": "/structure" }, { "page": true, "$component": { "src": "src/routes/topics.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/topics-BF3brWeF.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/topics-BF3brWeF.mjs'
) }, "path": "/topics" }];
...
function LangProvider(props) {
  const [lang, setLang] = createSignal(getInitialLang());
  createEffect(() => {
    return;
  });
  onMount(() => {
  ...
  return createComponent(LangContext.Provider, {
    value: {
      lang,
      setLang
    },
...
var _tmpl$$4 = ["<div", ' class="lang-buttons">', "</div>"], _tmpl$2$2 = ["<button", ' type="button"', ">", "</button>"];
const LANGS = [{
  code: "bg",
  label: "BG"
}, {
...
function LanguageSwitcher() {
  ...
  return ssr(_tmpl$$4, ssrHydrationKey(), escape(LANGS.map((l) => ssr(_tmpl$2$2, ssrHydrationKey(), ssrAttribute("class", lang() === l.code ? "active" : "", false), escape(l.label)))));
}
const logoUniv = "/_build/assets/swu-DmN_ATDE.png";
var _tmpl$$3 = ["<header", ' class="site-header"><nav class="site-nav"><a class="navLink" href="/">\u041D\u0430\u0447\u0430\u043B\u043E</a><a class="navLink" href="/structure">\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u043E\u043D\u043D\u0430 \u0441\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u0430</a><a class="navLink" href="/topics">\u041E\u0441\u043D\u043E\u0432\u043D\u0438 \u0442\u0435\u043C\u0438 \u043D\u0430 \u043A\u043E\u043D\u0444\u0435\u0440\u0435\u043D\u0446\u0438\u044F\u0442\u0430</a><img class="navLogo navLogoBig"', ' alt="SWU logo"><a class="navLink" href="/authors">\u0417\u0430 \u0430\u0432\u0442\u043E\u0440\u0438\u0442\u0435</a><a class="navLink" href="/location">\u041C\u0435\u0441\u0442\u043E\u043F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u0435</a><a class="navLink navLinkAccent" href="https://docs.google.com/forms/d/e/1FAIpQLScX2LXIdVwF6hW1FGtUdVBVC6rhiPOtOpc9YypDN0oPOiltpA/viewform?usp=header" target="_blank" rel="noopener">\u0418\u0437\u043F\u0440\u0430\u0442\u0438 \u0441\u0442\u0430\u0442\u0438\u044F</a></nav><div class="lang-switch">', "</div></header>"];
function App$1() {
  return createComponent(Router, {
    root: (props) => createComponent(MetaProvider, {
      get children() {
        return createComponent(LangProvider, {
          get children() {
            return [createComponent(Title, {
              children: "SolidStart"
            }), ssr(_tmpl$$3, ssrHydrationKey(), ssrAttribute("src", escape(logoUniv, true), false), escape(createComponent(LanguageSwitcher, {}))), createComponent(Suspense, {
              get children() {
                return props.children;
              }
            })];
...
const clientViteManifest = { "_HttpStatusCode-DjTx85av.js": { "file": "_build/assets/HttpStatusCode-DjTx85av.js", "name": "HttpStatusCode" }, "_lang-3XgYcF48.js": { "file": "_build/assets/lang-3XgYcF48.js", "name": "lang" }, "images/1.jpg": { "file": "_build/assets/1-Dds-0y4n.jpg", "src": "images/1.jpg" }, "images/2.jpg": { "file": "_build/assets/2-BZP38fBP.jpg", "src": "images/2.jpg" }, "images/3.jpg": { "file": "_build/assets/3-CO52-Bz_.jpg", "src": "images/3.jpg" }, "images/4.jpg": { "file": "_build/assets/4-BVsd3w8p.jpg", "src": "images/4.jpg" }, "images/swu.png": { "file": "_build/assets/swu-DmN_ATDE.png", "src": "images/swu.png" }, "images/technical.png": { "file": "_build/assets/technical-DJ1Ar0XL.png", "src": "images/technical.png" }, "src/entry-client.tsx": { "file": "_build/assets/entry-client-JjQgtK6O.js", "name": "entry-client", "src": "src/entry-client.tsx", "isEntry": true, "imports": ["_lang-3XgYcF48.js", "_HttpStatusCode-DjTx85av.js"], "dynamicImports": ["src/routes/[...404].tsx?pick=default&pick=$css", "src/routes/[...404].tsx?pick=default&pick=$css", "src/routes/authors.tsx?pick=default&pick=$css", "src/routes/authors.tsx?pick=default&pick=$css", "src/routes/index.tsx?pick=default&pick=$css", "src/routes/index.tsx?pick=default&pick=$css", "src/routes/location.tsx?pick=default&pick=$css", "src/routes/location.tsx?pick=default&pick=$css", "src/routes/structure.tsx?pick=default&pick=$css", "src/routes/structure.tsx?pick=default&pick=$css", "src/routes/topics.tsx?pick=default&pick=$css", "src/routes/topics.tsx?pick=default&pick=$css"], "css": ["_build/assets/entry-client-CV020Dr8.css"], "assets": ["_build/assets/swu-DmN_ATDE.png"] }, "src/routes/[...404].tsx?pick=default&pick=$css": { "file": "_build/assets/_...404_--0ymvRjf.js", "name": "_...404_", "src": "src/routes/[...404].tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_lang-3XgYcF48.js", "_HttpStatusCode-DjTx85av.js"] }, "src/routes/authors.tsx?pick=default&pick=$css": { "file": "_build/assets/authors-DmkSTCbl.js", "name": "authors", "src": "src/routes/authors.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_lang-3XgYcF48.js"] }, "src/routes/index.tsx?pick=default&pick=$css": { "file": "_build/assets/index-CUJSoJ6u.js", "name": "index", "src": "src/routes/index.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_lang-3XgYcF48.js"], "assets": ["_build/assets/1-Dds-0y4n.jpg", "_build/assets/2-BZP38fBP.jpg", "_build/assets/3-CO52-Bz_.jpg", "_build/assets/4-BVsd3w8p.jpg", "_build/assets/technical-DJ1Ar0XL.png"] }, "src/routes/location.tsx?pick=default&pick=$css": { "file": "_build/assets/location-MRkYvOZD.js", "name": "location", "src": "src/routes/location.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_lang-3XgYcF48.js"] }, "src/routes/structure.tsx?pick=default&pick=$css": { "file": "_build/assets/structure-ju4PpLaV.js", "name": "structure", "src": "src/routes/structure.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_lang-3XgYcF48.js"] }, "src/routes/topics.tsx?pick=default&pick=$css": { "file": "_build/assets/topics-DkbD74vf.js", "name": "topics", "src": "src/routes/topics.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_lang-3XgYcF48.js"] } };
...
async function createPageEvent(ctx) {
  ...
  const assets = [
    ...
    ...await manifest2.getAssets("/home/thoisoi/\u0414\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u044B/Projects/js/university/src/app.tsx")
...
export { HttpStatusCode as H, Title as T, entry$1 as e, useLang as u };
